...
void saadc_init(void)
{
    ...
    // 只设置上限值为: 设置为300
    nrfx_saadc_limits_set(0, NRFX_SAADC_LIMITL_DISABLED, 300);

    // 只设置下限值为: 设置为100
    // nrfx_saadc_limits_set(0, 100, NRFX_SAADC_LIMITH_DISABLED);

    // 同时设置上下限值，设置上限值 为300， 下限值为100
    // nrfx_saadc_limits_set(0, 100, 300);
